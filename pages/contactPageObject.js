...
class ContactPageObject {
    ...
    constructor() {
        this.contactLinkSelector = Selector('div.nav-collapse ul.nav li#nav-contact');
        ...
        this.exitMessage = Selector('div.ng-scope > div.alert.alert-success > strong.ng-binding');
    ...
    async navigateToContactPage(){
        await t.click(this.contactLinkSelector);
    }
...
export default new ContactPageObject();